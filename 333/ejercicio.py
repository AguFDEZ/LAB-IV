...
if uploaded_file:
    ...
    for producto in productos:
        with st.container():
            ...
            precio_promedio_actual = df_producto['Ingreso_total'].sum() / df_producto['Unidades_vendidas'].sum()
            margen_promedio_actual = (df_producto['Ingreso_total'].sum() - df_producto['Costo_total'].sum()) / df_producto['Ingreso_total'].sum()
            ...
            if not df_anterior.empty:
                precio_promedio_anterior = df_anterior['Ingreso_total'].sum() / df_anterior['Unidades_vendidas'].sum()
                margen_promedio_anterior = (df_anterior['Ingreso_total'].sum() - df_anterior['Costo_total'].sum()) / df_anterior['Ingreso_total'].sum()
